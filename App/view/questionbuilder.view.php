...
<html lang="en">
	<head>
		...
		<meta name="author" content="Samuel Molinski" />
			...
			<!-- <nav>
				...
				<form action="index_submit" method="get" accept-charset="utf-8" class="left">
					<fieldset id="qStatement" class="mainPanel">
						...
						<label for="qText" class="left clear"><span>Statement</span><textarea id="qText" name="qText" rows="15" cols="108"></textarea></label>
						...
						<div id="evalPanel" class="">
							<hr/>
							<label for="qEvalCode" class="clear"><span>Example Code</span><textarea id="qEvalCode" name="qEvalCode" rows="15" cols="108"></textarea></label>
							<hr/>
						</div>
					...
					<fieldset id="qAnswersC" class="mainPanel">
						...
						<label for="qAnswerTextC" class="clear"><span>Answer</span><textarea id="qAnswerTextC" name="qAnswerTextC" rows="4" cols="108"></textarea></label>
						<label for="qAnswersC" class="clear"><span>Previous Answers</span><textarea id="qAnswerC" name="qAnswersC" rows="5" cols="30" disabled="true"></textarea></label>
					...
					<fieldset id="qAnswersI" class="mainPanel">
						...
						<label for="qAnswerTextI" class="clear"><span>Answer</span><textarea id="qAnswerTextI" name="qAnswerTextI" rows="4" cols="108"></textarea></label>
						<label for="qAnswersI" class="clear"><span>Previous Answers</span><textarea id="qAnswersI" name="qAnswerI" rows="5" cols="30"  disabled="true"></textarea></label>
						<div class="subPanel right">
